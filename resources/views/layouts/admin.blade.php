...
<head>
  ...
  <meta name="csrf-token" content="Z9rNx4yLFksXt74Ot8uR9WhVWgs1Yb74HQcV8R8Q">
...
<!-- BEGIN: Page CSS-->
  ...
  <link rel="stylesheet" href="http://127.0.0.1:8000/css/base/pages/dashboard-ecommerce.css">
...
<div class="navbar-container d-flex content">
  <div class="bookmark-wrapper d-flex align-items-center">
    ...
    <ul class="nav navbar-nav bookmark-icons">
      <li class="nav-item d-none d-lg-block"><a class="nav-link" href="http://127.0.0.1:8000/app/email"
          data-bs-toggle="tooltip" data-bs-placement="bottom" title="Email"><i class="ficon"
            data-feather="mail"></i></a></li>
      <li class="nav-item d-none d-lg-block"><a class="nav-link" href="http://127.0.0.1:8000/app/chat"
          data-bs-toggle="tooltip" data-bs-placement="bottom" title="Chat"><i class="ficon"
            data-feather="message-square"></i></a></li>
      <li class="nav-item d-none d-lg-block"><a class="nav-link" href="http://127.0.0.1:8000/app/calendar"
          data-bs-toggle="tooltip" data-bs-placement="bottom" title="Calendar"><i class="ficon"
            data-feather="calendar"></i></a></li>
      <li class="nav-item d-none d-lg-block"><a class="nav-link" href="http://127.0.0.1:8000/app/todo"
  ...
  <ul class="nav navbar-nav align-items-center ms-auto">
    <li class="nav-item dropdown dropdown-language">
      ...
      <div class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdown-flag">
        <a class="dropdown-item" href="http://127.0.0.1:8000/lang/en" data-language="en">
          <i class="flag-icon flag-icon-us"></i> English
        </a>
        <a class="dropdown-item" href="http://127.0.0.1:8000/lang/fr" data-language="fr">
          <i class="flag-icon flag-icon-fr"></i> French
        </a>
        <a class="dropdown-item" href="http://127.0.0.1:8000/lang/de" data-language="de">
          <i class="flag-icon flag-icon-de"></i> German
        </a>
        <a class="dropdown-item" href="http://127.0.0.1:8000/lang/pt" data-language="pt">
      ...
      <ul class="dropdown-menu dropdown-menu-media dropdown-menu-end">
        ...
        <li class="scrollable-container media-list">
          <div class="list-item align-items-center">
            <img class="d-block rounded me-1" src="http://127.0.0.1:8000/images/pages/eCommerce/1.png" alt="donuts"
              width="62">
          ...
          <div class="list-item align-items-center">
            <img class="d-block rounded me-1" src="http://127.0.0.1:8000/images/pages/eCommerce/7.png" alt="donuts"
              width="62">
            <div class="list-item-body flex-grow-1">
              <i class="ficon cart-item-remove" data-feather="x"></i>
              <div class="media-heading">
          ...
          <div class="list-item align-items-center">
            <img class="d-block rounded me-1" src="http://127.0.0.1:8000/images/pages/eCommerce/2.png" alt="donuts"
              width="62">
            <div class="list-item-body flex-grow-1">
              <i class="ficon cart-item-remove" data-feather="x"></i>
              <div class="media-heading">
          ...
          <div class="list-item align-items-center">
            <img class="d-block rounded me-1" src="http://127.0.0.1:8000/images/pages/eCommerce/3.png" alt="donuts"
              width="62">
            <div class="list-item-body flex-grow-1">
              <i class="ficon cart-item-remove" data-feather="x"></i>
              <div class="media-heading">
          ...
          <div class="list-item align-items-center">
            <img class="d-block rounded me-1" src="http://127.0.0.1:8000/images/pages/eCommerce/5.png" alt="donuts"
              width="62">
            <div class="list-item-body flex-grow-1">
              <i class="ficon cart-item-remove" data-feather="x"></i>
              <div class="media-heading">
        ...
        <li class="dropdown-menu-footer">
          ...
          <a class="btn btn-primary w-100" href="http://127.0.0.1:8000/app/ecommerce/checkout">Checkout</a>
        </li>
      </ul>
    </li>
        ...
        <li class="scrollable-container media-list">
          <a class="d-flex" href="javascript:void(0)">
            <div class="list-item d-flex align-items-start">
              <div class="me-1">
                <div class="avatar">
                  <img src="http://127.0.0.1:8000/images/portrait/small/avatar-s-15.jpg" alt="avatar" width="32"
                    height="32">
                </div>
              </div>
              <div class="list-item-body flex-grow-1">
          ...
          <a class="d-flex" href="javascript:void(0)">
            <div class="list-item d-flex align-items-start">
              <div class="me-1">
                <div class="avatar">
                  <img src="http://127.0.0.1:8000/images/portrait/small/avatar-s-3.jpg" alt="avatar" width="32" height="32">
                </div>
              </div>
              <div class="list-item-body flex-grow-1">
    ...
    <li class="nav-item dropdown dropdown-user">
      <a class="nav-link dropdown-toggle dropdown-user-link" id="dropdown-user" href="javascript:void(0);"
        ...
        <span class="avatar">
          <img class="round"
            src="http://127.0.0.1:8000/images/portrait/small/avatar-s-11.jpg"
...
<ul class="main-search-list-defaultlist d-none">
  ...
  <li class="auto-suggestion">
    <a class="d-flex align-items-center justify-content-between w-100" href="http://127.0.0.1:8000/app/file-manager">
      <div class="d-flex">
        <div class="me-75">
          <img src="http://127.0.0.1:8000/images/icons/xls.png" alt="png" height="32">
        </div>
  ...
  <li class="auto-suggestion">
    <a class="d-flex align-items-center justify-content-between w-100" href="http://127.0.0.1:8000/app/file-manager">
      <div class="d-flex">
        <div class="me-75">
          <img src="http://127.0.0.1:8000/images/icons/jpg.png" alt="png" height="32">
        </div>
        <div class="search-data">
  ...
  <li class="auto-suggestion">
    <a class="d-flex align-items-center justify-content-between w-100" href="http://127.0.0.1:8000/app/file-manager">
      <div class="d-flex">
        <div class="me-75">
          <img src="http://127.0.0.1:8000/images/icons/pdf.png" alt="png" height="32">
        </div>
        <div class="search-data">
  ...
  <li class="auto-suggestion">
    <a class="d-flex align-items-center justify-content-between w-100" href="http://127.0.0.1:8000/app/file-manager">
      <div class="d-flex">
        <div class="me-75">
          <img src="http://127.0.0.1:8000/images/icons/doc.png" alt="png" height="32">
        </div>
        <div class="search-data">
  ...
  <li class="auto-suggestion">
    <a class="d-flex align-items-center justify-content-between py-50 w-100" href="http://127.0.0.1:8000/app/user/view">
      <div class="d-flex align-items-center">
        <div class="avatar me-75">
          <img src="http://127.0.0.1:8000/images/portrait/small/avatar-s-8.jpg" alt="png" height="32">
        </div>
        <div class="search-data">
  ...
  <li class="auto-suggestion">
    <a class="d-flex align-items-center justify-content-between py-50 w-100" href="http://127.0.0.1:8000/app/user/view">
      <div class="d-flex align-items-center">
        <div class="avatar me-75">
          <img src="http://127.0.0.1:8000/images/portrait/small/avatar-s-1.jpg" alt="png" height="32">
        </div>
        <div class="search-data">
  ...
  <li class="auto-suggestion">
    <a class="d-flex align-items-center justify-content-between py-50 w-100" href="http://127.0.0.1:8000/app/user/view">
      <div class="d-flex align-items-center">
        <div class="avatar me-75">
          <img src="http://127.0.0.1:8000/images/portrait/small/avatar-s-14.jpg" alt="png" height="32">
        </div>
        <div class="search-data">
  ...
  <li class="auto-suggestion">
    <a class="d-flex align-items-center justify-content-between py-50 w-100" href="http://127.0.0.1:8000/app/user/view">
      <div class="d-flex align-items-center">
        <div class="avatar me-75">
          <img src="http://127.0.0.1:8000/images/portrait/small/avatar-s-6.jpg" alt="png" height="32">
        </div>
        <div class="search-data">
...
<!-- END: Header-->
  ...
  <div class="main-menu-content">
    <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            <li >
        <a href="http://127.0.0.1:8000/dashboard/analytics" class="d-flex align-items-center"
          target="_self">
        ...
        <a href="javascript:void(0)" class="d-flex align-items-center"
          target="_self">
                  ...
                  <ul class="menu-content">
            <li >
        <a href="{{ route('admin.create') }}" class="d-flex align-items-center"
          target="_blank">
                    <span class="menu-item text-truncate">Basic</span>
        </a>
              </li>
          <li >
        <a href="http://127.0.0.1:8000/auth/register-cover" class="d-flex align-items-center"
          target="_blank">
        ...
        <a href="{{ route('categories.index') }}" class="d-flex align-items-center"
          target="_self">
                      <i data-feather="circle"></i>
                    <span class="menu-item text-truncate">Show</span>
        </a>
              </li>
          <li >
        <a href="{{ route('categories.create') }}" class="d-flex align-items-center"
          target="_self">
              ...
              <a href="javascript:void(0)" class="d-flex align-items-center"
                target="_self">
                <i data-feather="grid"></i>
                <span class="menu-title text-truncate">Posts</span>
                              </a>
                              <ul class="menu-content">
            <li >
          ...
          target="_self">
            ...
            <li >
                <form id="logout-form" action="{{ route('admin.logout') }}" method="POST"  class="d-flex align-items-center"
                  target="_self">
                  @csrf
                  <button type="submit" class=" menu-item text-truncate d-flex align-items-center"
                    target="_self">Logout</button>
                </form>
            </li>
...
<!-- BEGIN: Page JS-->
  ...
  <script src="http://127.0.0.1:8000/js/scripts/pages/dashboard-ecommerce.js"></script>
<!-- END: Page JS-->
